        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          {skillGroups.map((group, groupIndex) => (
            <motion.div
              ...
              className="rounded-[28px] border border-slate-200 bg-white/60 p-6 shadow-xl shadow-slate-900/5 dark:border-slate-800 dark:bg-slate-900/60"
            >
                  ...
                  <div key={skill.name}>
                    ...
                    <div className="h-2.5 rounded-full bg-slate-200 dark:bg-slate-800">
                      <motion.div
                        ...
                        className={`h-2.5 rounded-full bg-gradient-to-r ${group.accent}`}
                      ></motion.div>
                    </div>
                  </div>
                ))}
